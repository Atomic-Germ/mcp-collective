module.exports = {
  ...
  moduleNameMapper: {
    ...
    "@langchain/community/vectorstores/hnswlib":
      "<rootDir>/src/__mocks__/@langchain/community/vectorstores/hnswlib.js",
    // OpenAIEmbeddingsのモック
    "@langchain/openai": "<rootDir>/src/__mocks__/@langchain/openai.js",
    // DirectoryLoaderのモック
    "langchain/document_loaders/fs/directory":
      "<rootDir>/src/__mocks__/langchain/document_loaders/fs/directory.js",
    // TextLoaderのモック
    "langchain/document_loaders/fs/text":
      "<rootDir>/src/__mocks__/langchain/document_loaders/fs/text.js",
